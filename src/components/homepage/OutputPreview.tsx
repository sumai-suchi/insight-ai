...
export default function OutputPreview() {
  ...
  return (
    <motion.div
      className="flex items-center max-w-7xl mx-auto justify-center p-6 bg-gray-100 rounded-xl"
    ...
    >
      ...
      >
        <div className="px-6 py-4 bg-gray-100">
          <h1 className="text-xl font-bold text-black">Output Preview</h1>
        ...
        <div className="p-6">
          <p className="text-base flex items-center gap-2 font-semibold mb-4 text-black">
            <FaRegEdit className="text-green-500 text-2xl cursor-pointer hover:text-green-700 transition duration-200" />{" "}
            Edit your generated content below
          </p>
