...
//               <button
//                 className="bg-blue-400 text-white p-1 rounded-b-sm"
//                 onClick={() => {
//                   handleDemoLogin("rabeya@gmail.com", "Rabeya@123");
//                 }}
//               >
//                 {" "}
//                 user
...
//                 className="bg-blue-400 text-white p-1 rounded-b-sm"
//                 onClick={() => {
//                   handleDemoLogin("sumaiyamoina@gmail.com", "Sumaiya@123");
//                 }}
//               >
//                 {" "}
//                 admin
...
//                 className="bg-blue-400 text-white p-1 rounded-b-sm"
//                 onClick={() => {
//                   handleDemoLogin("hatim@gmail.com", "Hatim@123");
//                 }}
//               >
//                 {" "}
//                 editor
